...
void enc28j60Init( uint8_t* macaddr )
{
    ...
    uint8_t erxfcon1 = enc28j60Read(ERXFCON) | ERXFCON_BCEN;
	enc28j60Write(ERXFCON, erxfcon1 );
  ...
  enc28j60Write(MAADR0, macaddr[5]);
	...
	//enc28j60PhyWrite(PHCON1, PHLCON_LACFG2|PHLCON_LBCFG2|PHLCON_LBCFG1|PHLCON_LBCFG0|PHLCON_LFRQ0|PHLCON_STRCH);
	// switch to bank 0
